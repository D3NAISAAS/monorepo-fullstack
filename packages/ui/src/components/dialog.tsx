...
>(({ className, ...props }, ref) => (
	<DialogPrimitive.Overlay
		ref={ref}
		className={cn(
			"fixed inset-0 z-50 desktop:rounded-[10px] bg-[#f6f6f3]/60 data-[state=closed]:animate-[dialog-overlay-hide_100ms] data-[state=open]:animate-[dialog-overlay-show_100ms] dark:bg-[#121212]/80",
			className
		)}
		{...props}
	/>
...
>(({ className, children, hideClose, ...props }, ref) => (
	<DialogPortal>
		...
		<DialogPrimitive.Content
			ref={ref}
			className={cn(
				"-translate-x-1/2 -translate-y-1/2 fixed top-1/2 left-1/2 z-50 w-[90vw] max-w-xl border border-border bg-background text-primary data-[state=closed]:animate-[dialog-content-hide_100ms] data-[state=open]:animate-[dialog-content-show_100ms] dark:p-px",
				className
			)}
			{...props}
		>
